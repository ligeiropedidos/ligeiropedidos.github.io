...
(function () {
  ...
  function termos(raiz) {
    ...
    return paginaLegal(raiz, 'Termos de uso', [
      ...
      ['Mudanças nestes termos', ['Se os termos mudarem de um jeito que importa, o painel pede um novo aceite antes de continuar. Versão de ' + R.TERMOS_VERSAO.split('-').reverse().join('/') + '.']],
